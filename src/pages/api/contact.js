...
function detectSpam(formData) {
  const { firstName, lastName, email, phone, subject, message, honeypot, submissionTime } = formData;
...
export default async function handler(req, res) {
  ...
  try {
    const { firstName, lastName, email, phone, subject, message, honeypot, submissionTime } = req.body;
    ...
    if (spamCheck.isSpam) {
      ...
      console.log('Form data:', { firstName, lastName, email, phone, subject, honeypot });
