          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                solutions, we have been at the forefront of industry changes and
                technological advancements.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                Our journey began with a simple mission: to help businesses
                thrive in an ever-evolving digital landscape. Today, we continue
                to uphold this mission while adapting to new challenges and
                opportunities.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                ...
                details to the biggest projects.
              </p>
            </div>
          </div>
        </div>
